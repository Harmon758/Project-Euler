...
for i in range(T):
    ...
    if Two_Pairs(Sorted_Numbers1) != 0 and Two_Pairs(Sorted_Numbers2) == 0:
        ...
        print "Player", Check_High_Card(Two_Pairs(Sorted_Numbers1), Two_Pairs(Sorted_Numbers2))
        continue
    if One_Pair(Sorted_Numbers1) != 0 and One_Pair(Sorted_Numbers2) == 0:
        ...
        print "Player", Check_High_Card(One_Pair(Sorted_Numbers1), One_Pair(Sorted_Numbers2))
        continue
