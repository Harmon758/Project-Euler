...
Hands_File = open("p054_poker.txt", 'r')
Count = 0
for i in range(1000):
    Hands = Hands_File.readline().split()
    Hand1 = Hands[:5]
    Hand2 = Hands[5:]
    ...
    if Check_Straight_Flush(Hand1, Hand2) != 0:
        Player = Check_Straight_Flush(Hand1, Hand2)
    elif Check_Four_Of_A_Kind(Sorted_Numbers1, Sorted_Numbers2) != 0:
        Player = Check_Four_Of_A_Kind(Sorted_Numbers1, Sorted_Numbers2)
    elif Check_Full_House(Sorted_Numbers1, Sorted_Numbers2) != 0:
        Player = Check_Full_House(Sorted_Numbers1, Sorted_Numbers2)
    elif Check_Flush(Hand1, Hand2) != 0:
        Player = Check_Flush(Hand1, Hand2)
    elif Check_Straight(Sorted_Numbers1, Sorted_Numbers2) != 0:
        Player = Check_Straight(Sorted_Numbers1, Sorted_Numbers2)
    elif Check_Three_Of_A_Kind(Sorted_Numbers1, Sorted_Numbers2) != 0:
        Player = Check_Three_Of_A_Kind(Sorted_Numbers1, Sorted_Numbers2)
    elif Check_Two_Pairs(Sorted_Numbers1, Sorted_Numbers2) != 0:
        Player = Check_Two_Pairs(Sorted_Numbers1, Sorted_Numbers2)
    elif Check_One_Pair(Sorted_Numbers1, Sorted_Numbers2) != 0:
        Player = Check_One_Pair(Sorted_Numbers1, Sorted_Numbers2)
    else:
        Player = Check_High_Card(Sorted_Numbers1[::-1], Sorted_Numbers2[::-1])
    if Player == 1:
        Count += 1
print Count
Wait = raw_input()